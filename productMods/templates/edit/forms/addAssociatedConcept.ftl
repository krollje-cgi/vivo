...
<p>To add expertise to your profile, click on "Add Expertise", enter a term in the search field, select a vocabulary and then click on the "Search" button.  Please make sure to click on the “Search” button rather than hitting the “Enter” key.  If no results are found, you should search within the other vocabularies as well before creating your own expertise.</p>

<p>Once you have found a relevant term, check the box next to it and click on the “Add Selected Expertise” button.  You should only select one term at a time.</p>
...
<div id="showAddForm">
    ...
    <#list sources?values?sort_by("label") as thisSource>
        <input type="checkbox"  name="source" value="${thisSource.schema}" role="checkbox" checked="checked">
    ...
    <p class="inline-search">
        ...
        <input type="submit" class="submit concept-search" id="searchButton" name="searchButton" value="${i18n().search_button}"/>&nbsp;
